...
![](assets/3-锁/1738590539469-8e488215-f866-4478-b364-8d4d6f5cd924.png)

三分恶面渣逆袭：monitorenter和monitorexit
②、synchronized 修饰方法时，JVM 会通过 `ACC_SYNCHRONIZED` 标记符来实现同步。
![](assets/3-锁/1738590539274-3ea92dd0-b6d4-40ac-a972-b118b9065446.png)
...
- 就诊结束后，**走出就诊室**，候诊室的**下一位候诊患者**进入就诊室。![](assets/3-锁/1738590539183-63697a32-060e-4632-a451-a3de9dada369.png)
...
- **候诊室**：就诊室繁忙时，进入**等待区（Wait Set）**，就诊室空闲的时候就从**等待区（Wait Set）**叫新的线程![](assets/3-锁/1738590539035-7bb9315f-9280-4691-932c-9f2abbf3369d.png)
...
![](assets/3-锁/1738590539102-c26d77e2-161e-43af-8f1c-1ac5068888e1.png)
...
无锁-->偏向锁---> 轻量级锁---->重量级锁。
![](assets/3-锁/1738590539273-1f9390fe-8d0b-40d2-8270-b4e6c1afdf5b.png)

三分恶面渣逆袭：锁升级方向
稍微加点描述：
![](assets/3-锁/1738590539344-06ba85c5-ad80-4cb4-ba4f-b449be63416b.png)

三分恶面渣逆袭：锁升级简略过程
完整的升级过程：
![](assets/3-锁/1738590540187-8f8906f8-897e-4e9a-aeb6-d03b82c845fd.png)
...
![](assets/3-锁/1738590539820-f88296c5-3ae9-4143-bb9e-027fcb7bc223.png)
...
![](assets/3-锁/1738590540460-5a5b25a2-1d3d-4d21-a94d-b6b448e16a14.png)
...
![](assets/3-锁/1738590539642-fdfa30c0-bcd8-48a1-864b-44097708af65.png)
...
![](assets/3-锁/1738590539714-9d642724-41f8-43e6-8d2b-13ac9c9f2203.png)

三分恶面渣逆袭：CLH队列
在 CLH 锁中，当一个线程尝试获取锁并失败时，它会将自己添加到队列的尾部并自旋，等待前一个节点的线程释放锁。
![](assets/3-锁/1738590540012-6702b527-3152-4b35-98e0-793bd133503e.png)
...
![](assets/3-锁/1738590540017-2f8c7244-8af3-4f40-81ff-69eb37ef7dba.png)
...
![](assets/3-锁/1738590540166-01a9143d-3032-428d-b750-2881567f32e7.png)
...
![](assets/3-锁/1738590541467-73bded28-2802-486b-a3ef-e6d5e3d08eaf.png)
...
![](assets/3-锁/1738590541214-97a56338-bd04-458d-b8e1-c9744cc62656.png)

为了保证CAS的原子性，CPU 提供了两种实现方式：
①、总线锁定，通过锁定 CPU 的总线，禁止其他 CPU 或设备访问内存。在进行操作时，CPU 发出一个 LOCK 信号，这会阻止其他处理器对内存地址进行操作，直到当前指令执行完成。
![](assets/3-锁/1738590540810-3d64dcac-97c4-4f25-8e3a-8e4769738151.png)
...
CAS 存在三个经典问题。
![](assets/3-锁/1738590540475-f1e6d603-1b7d-40a0-96aa-69a65bc8ed21.png)
...
![](assets/3-锁/1738590540816-86e6d881-ae82-40e8-be31-3ed8ea4028e7.png)
...
![](assets/3-锁/1738590540845-ec4879b0-bddf-4597-8f61-bf6d56d03d6b.png)
...
![](assets/3-锁/1738590541133-e03cc400-c1cd-4165-ba3e-2ad88020ddbe.png)
...
![](assets/3-锁/1738590541074-789c4e39-8b60-43b1-9c8e-173fd1668d97.png)
...
![](assets/3-锁/1738590541077-b088c72d-b82f-4333-9ec9-6438086cef67.png)
...
运行这段代码，果然卡住了。
![](assets/3-锁/1738590541514-687f21aa-2f4d-4f8a-bf59-7d4f323bf248.png)

运行 `jstack pid` 命令，可以看到死锁的线程信息。诚不欺我！
![](assets/3-锁/1738590542178-58004926-f788-4a77-a810-e8f3e31b446b.png)

也可以使用一些可视化的性能监控工具，比如说 JConsole、VisualVM 等。
![](assets/3-锁/1738590541824-8659dbb9-91b1-4726-baab-869880e2f6e6.png)
...
![](assets/3-锁/1738590541891-a75ed2cc-33c1-4fb8-ba2f-efafda74f1aa.png)
...
```
![](assets/3-锁/1738590542528-785f87b8-c3d8-4642-8fba-bcb8e47e9f56.png)
...
![](assets/3-锁/1738590542115-dec4a328-e4fc-4300-af57-c5efef688159.jpeg)
