...
![](assets/1738590545804-1ecb1475-0086-4e40-ab56-f141a6b41fd3.png)
...
![](assets/1738590546935-92acef54-5cb4-4ed4-adda-9a1959476cd4.png)
...
![](assets/1738590546179-08223f9e-101d-4e9c-912d-8bdc8be23146.png)

三分恶面渣逆袭：直接办理
第二种情况，小姐姐们都在忙，接待员小美招呼小二去排队区区取号排队，让小二稍安勿躁。
![](assets/1738590546167-0b579427-9721-4bb7-9348-aaee80a37a83.png)

三分恶面渣逆袭：排队等待
第三种情况，不仅小姐姐们都在忙，排队区也满了，小二着急用钱，于是脾气就上来了，和接待员小美对线了起来，要求开放另外 3 个空闲的窗口。
小美迫于小二的压力，开放了另外 3 个窗口，排队区的人立马就冲了过去。
![](assets/1738590546381-c7ad8909-9655-435f-aebb-34bc938b21b9.png)

三分恶面渣逆袭：排队区满
第四种情况，6 个窗口的小姐姐都在忙，排队区也满了。。。
![](assets/1738590546414-14118bfe-6ed8-45f5-9e50-5c66a6374d66.png)
...
- 如果等待队列满了，而且正在运行的线程数量大于或等于 maximumPoolSize，那么线程池会执行拒绝策略。![](assets/1738590546437-b36555ce-1f63-4187-8f18-a691374facc5.png)
...
![](assets/1738590546661-0c82e79f-3a05-4c56-a7a2-aec51b8a8eef.png)
...
- DiscardPolicy：策略会默默地丢弃被拒绝的任务，不做任何处理也不抛出异常。![](assets/1738590546769-e1edfb95-0f3f-4300-8790-fbaea2eb5604.png)
...
![](assets/1738590546699-783aa211-0340-4cd4-a7f5-d8aedd2dd487.png)
...
![](assets/1738590547517-bf6c8304-fedd-48e6-958b-e45ee267e3c7.png)
...
![](assets/1738590547085-54a3feb1-c566-4085-b452-831eee2a3315.png)
...
![](assets/1738590546973-4640e23d-1a52-4ac0-8787-406ebc90cf50.png)
...
- keepAliveTime 为 0![](assets/1738590547027-5139e3a4-0bbf-454a-8936-a77719e7546e.png)
...
- 阻塞队列为无界队列 LinkedBlockingQueue，可能会导致 OOM![](assets/1738590547204-310d0bb5-296d-4a3d-b710-e2683448b958.png)
...
![](assets/1738590547220-4ae192db-d671-418e-8822-82409d1233c6.png)
...
- scheduleWithFixedDelay()：在某个延迟后执行![](assets/1738590547245-47079044-9cb4-4b7a-8c94-4d348ed979cd.png)
...
- 线程把这个修改 time 之后的 ScheduledFutureTask 放回 DelayQueue 中（DelayQueue.add()）。![](assets/1738590547402-d8ea02ff-f339-48d5-9c35-3dfcdea773aa.png)
...
常见的异常处理方式：
![](assets/1738590547444-d49fa283-cfbd-4cd1-9c57-8436ca72c9e1.png)
...
```
线程池各个状态切换图：
![](assets/1738590547465-5adf0c40-ed75-4552-9504-e2ca502e71f0.png)
...
![](assets/1738590547559-31ea75f5-2530-4e19-a04c-97d253dfb5bb.png)

JDK 线程池参数设置接口来源参考[7]
这里主要有两个思路：
![](assets/1738590547658-48f561e3-0a58-4e1f-96f5-b3c1cbd8d830.png)
...
![](assets/1738590547814-38d2b45a-03b3-4c4c-bae2-26c5789c0f81.png)

线程池评估方案 来源参考[7]
上线之前也要进行充分的测试，上线之后要建立完善的线程池监控机制。
事中结合监控告警机制，分析线程池的问题，或者可优化点，结合线程池动态参数配置机制来调整配置。
事后要注意仔细观察，随时调整。
![](assets/1738590547999-cce68809-a403-40e7-9ecd-a223bb5e47f2.png)
...
4. 拒绝策略：当任务队列满时，处理新任务的策略。![](assets/1738590548004-96303ece-7079-42e2-8013-f74550b4fabc.png)
...
```
执行结果：
![](assets/1738590548455-3738353b-2835-449b-910e-8383120a42ce.png)
...
```
运行结果：
![](assets/1738590549051-58083115-500f-4301-bb26-4808ca1356f7.png)
