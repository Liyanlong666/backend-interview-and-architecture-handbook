...
![](assets/1738590542225-ee89785a-19fb-4338-b372-3065b8dd7503.jpeg)
...
![](assets/1738590542298-01185180-b0f1-4c49-828b-6f8aa3d614e3.jpeg)
...
![](assets/1738590542551-59b57da6-2bb0-4433-9b01-e6f6653eae4a.png)

想结衣结衣不依,迷爱理爱理不理。
我们拿代码模拟这一场景，发现 CountDownLatch 无能为力了，因为 CountDownLatch 的使用是一次性的，无法重复利用，而这里等待了两次。此时，我们用 CyclicBarrier 就可以实现，因为它可以重复利用。
![](assets/1738590542834-ed21ff79-a2e9-4189-b28d-e9665dacdbaf.png)

小约翰可汗选妃模拟代码
运行结果：
![](assets/1738590542671-f77ae907-6237-4367-9e11-1af77336b376.png)

运行结果
CyclicBarrier 最最核心的方法，仍然是 await()：

- 如果当前线程不是第一个到达屏障的话，它将会进入等待，直到其他线程都到达，除非发生**被中断**、**屏障被拆除**、**屏障被重设**等情况；上面的例子抽象一下，本质上它的流程就是这样就是这样：
![](assets/1738590542587-ab9eb05e-db08-4b3f-931a-beea36f75d31.png)
...
![](assets/1738590543480-1a2c57ff-98b2-4f91-a9d5-4887c7c3db8f.jpeg)

停车场空闲车位提示-图片来源网络
我们把这个例子类比一下，车辆就是线程，进入停车场就是线程在执行，离开停车场就是线程执行完毕，看见红灯就表示线程被阻塞，不能执行，Semaphore 的本质就是**协调多个线程对共享资源的获取**。
![](assets/1738590543557-7c59f398-92fd-4769-9244-8bbe3cfd04c5.jpeg)
...
![](assets/1738590543535-c1a2801a-45ff-4b03-b3ed-77eda486bcc9.jpeg)
...
![](assets/1738590544527-0721714e-c5d5-464f-9b76-c9294f9600fd.png)
...
![](assets/1738590544318-5a8f26c4-7ca8-4dac-bc3e-e3aef2ef090d.png)
...
![](assets/1738590544238-b1588836-9ca0-469e-951e-924d00ac0f24.png)
...
4. 释放锁。![](assets/1738590544715-506550e6-b65d-4652-9db0-1cee4d308d15.png)
...
![](assets/1738590545238-674bf6a2-e383-4269-b486-f6488d311a00.png)

二哥的 Java 进阶之路：put 源码
ConcurrentHashmap JDK 8 put 流程图：
![](assets/1738590544542-86a12dea-6262-46d9-a2e9-a84c4ba823cf.jpeg)
...
![](assets/1738590545515-16c41e34-a9e1-4976-93d4-9ccdd7b6ff78.png)
...
![](assets/1738590545521-98e4b5f7-c6d0-4dba-ba74-a26531f511bc.png)
...
![](assets/1738590545963-7e24c99d-0026-4014-b9a6-cdbed306995b.png)
...
![](assets/1738590545431-224bcaa0-56a5-49b3-9e4f-736d01bd84a4.png)
...
![](assets/1738590545472-5a5d1387-4ab5-4203-b633-b2912fdbe2b3.png)
...
![](assets/1738590545801-d725d4e9-7d48-4140-9019-8c3cbd830b4b.png)
...
![](assets/1738590545748-895bc2ff-9df7-47b3-8348-b2228bd049a8.jpeg)
